...
// TODO: Update to use ModelRouter and new architecture
...
export class ParameterRecoveryUtils {
  ...
  static async testSingleRecovery(
    ...
    engine: any, // TODO: Update to use ModelRouter
    modelType?: any
    ...
    const recovered = this.extractParameters(
      result.posterior,
      actualModelType || modelType || dataset.groundTruth.type
    );
  ...
  private static compareParameters(groundTruth: any, recovered: any, posterior: any): any {
    ...
    if (recovered.frequency) {
      ...
      return {
        ...
        coverageCheck:
          recovered.frequency.ci[0] <= trueConvRate && recovered.frequency.ci[1] >= trueConvRate,
